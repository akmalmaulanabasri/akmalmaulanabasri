    ...
    <div class="container">
        <div class="card shadow">
            ...
            <div class="card-body text-dark">
                <form action="{{ route('tambah-artikel-baru') }}" method="POST" class="form-group"
                    ...
                    <input type="text" name="kategori" id="kategori" placeholder="Kategori Artikel"
                        class="form-control mb-2 @error('kategori') is-invalid @enderror" value="{{ old('kategori') }}">
                    @error('kategori')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <input type="text" name="penulis" id="penulis" placeholder="Penulis"
                        class="form-control mb-2 @error('penulis') is-invalid @enderror" value="{{ old('penulis') }}">
                    @error('penulis')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    @enderror
                        ...
                        <input id="artikel" type="hidden" name="artikel">
