...
<head>
    ...
    <title>Akmal Website | Dashboard</title>
    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
                <div class="sidebar-brand-text mx-3">Dashboard <sup>Akmal</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Showcase Project</h6>
                        <a class="collapse-item" href="{{ route('tambah-project') }}">Tambah Project</a>
                        <a class="collapse-item" href="{{ route('showcase-project') }}">Daftar Project</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('home') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            <i class="bi bi-eye"></i> Go To Home Page</a>
                    </div>
